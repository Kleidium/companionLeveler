...
stuff.guildTrainedMessages = {
	...
	[9] = "House Hlaalu has shown a vested interest in this creature's future, due to its potential for making them money.", -- Receive gold per level based on current level?
...
stuff.guildTrainedHints = {
	...
	[9] = "House Hlaalu provides a small stipend each level.", -- Receive gold per level based on current level?
	[10] = "Attacks from this creature may deal critical damage.", --Critical strike chance
	[11] = "Prevents resting from being interrupted.", --instantly damages ambushing enemies, buffs player.
	[12] = "Set a tracking target as a technique, and be automatically alerted when the target is nearby.", --Detect NPCs by name, change tracked name as a technique.
	[13] = "Automatically detect the presence of glass and ebony in interiors.", -- Detects Glass/Ebony nodes upon cell change.
