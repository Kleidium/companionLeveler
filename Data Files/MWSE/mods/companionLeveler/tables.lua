...
stuff.guildTrainedMessages = {
	[1] = "This organism was chosen for further study by the Guild of Mages due to its abnormal affinity to magicka.", --magicka pool increase, +1 TP
	...
	[9] = "House Hlaalu has agreed to sponsor this creature in order to use it as a tool to increase their own reputation.", -- Receive gold per level based on current level?
	...
	[11] = "The Legion employed this creature as a sentry, utilizing their naturally sharp senses to detect intruders.", --instantly damages ambushing enemies, buffs player.
	[12] = "The Imperial Census and Excise employed this creature to assist in collecting unpaid taxes through asset forfeiture.", --Detect NPCs by name, change tracked name as a technique.
	[13] = "The East Empire Company taught this creature to fill their purses by surveying caves and sniffing out natural glass and ebony deposits.", -- Detects Glass/Ebony nodes upon cell change.
	...
	[15] = "This creature once roamed about with Ashlanders, and was trained to hunt other beasts alongside the Ashland nomads.", --5% dmg to all beasts, blight resistance
	...
	[20] = "The Imperial Astrological Society permanently altered this creature after attuning it to various doom stones for study.", --As the months change, so too does the creature's benefits.
	[21] = "This creature toured the world at the behest of the Imperial Geographical Society, traveling with various adventurers." --+3 to all stats
}
...
stuff.guildTrainedHints = {
	...
	[8] = "Ash Creatures incite a fervor upon this creature in combat.", -- Trigger enrage when engaging Ash Creatures.
	[9] = "(Reputation) House Hlaalu provides a small stipend each level. Increases with player reputation and companion level.", -- Receive gold per level based on current level?
	[10] = "Attacks from this creature have a 5% chance of dealing critical damage.", --Critical strike chance
	[11] = "Prevents resting from being interrupted.", --instantly damages ambushing enemies, buffs player.
	[12] = "Passively detect nearby enchanted items.", --Detect NPCs by name, change tracked name as a technique.
	[13] = "Automatically detect the presence of nearby glass and ebony deposits.", -- Detects Glass/Ebony nodes upon cell change.
	[14] = "Immediately escape most interiors as a technique.", --ninja technique, or speed aura
	[15] = "Attacks from this creature deal 5% additional damage to all other creatures.", --Ashstorms trigger a buff.
	[16] = "Consume skooma as a technique, providing useful benefits.", --Consume Skooma as a technique.
	[17] = "Attacks from this creature deal 7% additional damage to all non-Dunmer humanoids.", -- +5% dmg to all non-Dunmer
	[18] = "An Ancestral Guardian protects this creature in combat.", -- Ancestor Guardian follows, comes back
	[19] = "Automatically detect the presence of exceptionally rare and unique artifacts.", --Detect powerful artifacts upon change cell
	[20] = "As the months change, so too does the creature's benefits.", --As the months change, so too does the creature's benefits.
	[21] = "Technique Points increase by 1." --+3 to all stats
}
